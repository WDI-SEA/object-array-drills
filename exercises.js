...
let band = {name:"Talking Heads", members:"David Byrne, Tiny Weymouth, Chris Franz, Jerry Harrison", albums: talkingHeadsAlbums}
...
const thAlbums = talkingHeadsAlbums.length;

if (thAlbums % 2 === 0 && thAlbums % 3 === 0) {
console.log(`The number ${thAlbums} is divisible by 2 and 3`);
} else if (thAlbums % 2 === 0) {
console.log(`The number ${thAlbums} is divisible by 2`);
} else if (thAlbums % 3 === 0) {
console.log(`The number ${thAlbums} is divisible by 3`);
} else {
console.log(`The number ${thAlbums} is not divisible by 2 or 3`);
}
...
if (talkingHeadsAlbums.length % 2 == 0) {
  ...
  console.log(`The number ${talkingHeadsAlbums.length} is not divisible by 2`)
}
/////////////////////////////////////////////////////
// Part 4: For Loops
/////////////////////////////////////////////////////
