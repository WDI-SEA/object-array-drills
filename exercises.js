...
console.log(album3.albumDetails.released.toString())
...
for (let i = 0; i < band.albums.length; i++) {
  ...
  //check label string
  if (typeof band.albums[i].albumDetails.label === 'string' && band.albums[i].albumDetails.label === 'Sire') {
    sireTally++

    //check labels array
  } else if (band.albums[i].albumDetails.labels[0] === "Sire" || band.albums[i].albumDetails.labels[1] === "Sire") {
    sireTally++
  }
}
