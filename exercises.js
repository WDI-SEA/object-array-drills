...
let allAlbums = band.albums.length

if ( allAlbums % 2 === 0 ) {
  console.log("The number " + allAlbums + " is even")
} else {
  console.log("The number " + allAlbums + " is odd")
}
...
if ( allAlbums % 2 === 0 && allAlbums % 3 !== 0){
  console.log("The number " + allAlbums + " is divisible by 2")
} else if ( allAlbums % 3 === 0 && allAlbums % 2 !== 0) {
  console.log("The number " + allAlbums + " is divisible by 3")
} else if ( allAlbums % 2 === 0 && allAlbums % 3 === 0) {
  console.log("The number" + allAlbums + " is divisible by 2 and 3")
} else {
  console.log("The number" + allAlbums + " is not divisible by 2 or 3")
}
