...
const album = album.albumDetails.label
 console.log(album)
...
// const newTitle = albumDetails.title
//  console.log(title + ' :77')
...
// const newAlbum = album2.formats([])
//   console.log(album3.formats.push)


album3.albumDetails.formats.push(album2.albumDetails.formats[0])

//  or
const album3 = album2.albumDetails.formats.push[LP]
 console.log(album3)
...
band.members.push(Tiany Weymouth, tianngy)
/////////////////////////////////////////////////////
// Part 4: For Loops
/////////////////////////////////////////////////////
...
talkingHeadsAlbums,forEach(album => {
  console.log(album.albumDetails.label) // checks to see what has singular or plural label
  if (album.albumDetails.label) {
    console.log('it has label no s')
  } else if (album.albumDetails.labels) {
    console.log('it has labels with s')
