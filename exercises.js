...
// // // console.log(album1[0]="Talking Heads: 77")

// //  const album1.title = "Talking Heads: 77" 
...
// // const released = Date.parse('01 Jan 1970 00:00:00 GMT');
...
// album4.albumDetails.push({label: 'Sire'})
// console.log(Album4)
...
// // album6.albumDetails.labels[1] = albumDetails.labes[1].toLocaleUpperCase())
// console.log(album6)
...
// //    talkingHeadsAlbums above.
  ...
  if (talkingHeadsAlbum.length >= 6) {
    console.long('Talking Heads were a prolific band')
  } else {
...
if(num % 2 === 0) {
  console.log('the bumber ' + num + ' is even')
} else {'the bumber ' + num + ' is even'
   console.log('the bumber ' + num + ' is odd')
}
...
for (let i=0; i< talkingHeadsAlbums.length;  i++) {
  const album = talkinHeadsAlbums[i]
  if(album.albumDetails.labels)&& album.albumDetails.labels.includes('Sire')) { sireTally++
      
    }
  } else i (album.albumDetails.labels === 'Sire') {
    sireTally++
  }
}
