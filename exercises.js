...
// Look ahead to album4 for a clu
...
const newAlbums = talkingHeadsAlbums.length
if(numAlbums % 2 != 0) {
...
let y = numAlbums
if (y % 2 != 0 && y % 3 != 0) {
  console.log('the number is not divisible by two or three')
} else if (y % 2 === 0 && y % 3 === 0) {
  console.log('the number is divisible by two or three')
} else if (y % 3 === 0) {
...
talkingHeadsAlbums.forEach(album => {
  if (album.albumDetails.label === "sire") {
    ...
    // console.log('It has labels with n s')
  }
})
