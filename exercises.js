...
//album3.albumDetails.released.push(newDate"August 3, 1979")
...
//console.log(band.albums[0].title)
...
let sireTally = 0
for (let i = 0; i < band.albums.length; i++){
  if(band.albumDetails.labels.includes('Sire')){
    sireTally++
  }
 for(let i = 0; i < band.labels; i++) 
}
