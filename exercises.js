...
// album4.albumDetails["label"] = "Sire";    // Testing bracket notation for dynamically determined values
...
album5.albumDetails.formats.push("CD");
album5.albumDetails.formats.push("Cassette");
album5.albumDetails.formats.push("LP");
...
let talkingHeadsAlbumNum = talkingHeadsAlbums.length;
if (talkingHeadsAlbumNum >= 6)
{
...
if (talkingHeadsAlbumNum % 2 === 0)
{
  console.log("The number " + talkingHeadsAlbumNum + " is even");
}
else
{
  console.log("The number " + talkingHeadsAlbumNum + " is odd");
}
...
if (talkingHeadsAlbumNum % 2 === 0)
{
  if (talkingHeadsAlbumNum % 3 === 0)
  {
    console.log("The number " + talkingHeadsAlbumNum + " is divisible by 2 and 3");
  }
  else
  {
    console.log("The number " + talkingHeadsAlbumNum + " is divisible by 2");
  }
}
else if (talkingHeadsAlbumNum % 3 === 0)
{
  console.log("The number " + talkingHeadsAlbumNum + " is divisible by 3");
}
else
{
  console.log("The number " + talkingHeadsAlbumNum + " is not divisible by 2 or 3");
}
...
for (let i = 0; i < talkingHeadsAlbumNum; i++)
{
...
for (let i = 0; i < talkingHeadsAlbumNum; i++)
{
  ...
  else if ((talkingHeadsAlbums[i].albumDetails.labels !== undefined) || (talkingHeadsAlbums[i].albumDetails.labels !== null))
  {
    for (let j = 0; j < talkingHeadsAlbums[i].albumDetails.labels.length; j++)
    {
...
{
  let message = "Welcome, " + ticketSections[i].name + "! ";
  switch(ticketSections[i].type)    //Checks for type of ticket
  {
    case "premium":
      if (ticketSections[i].seats > 1)    // Are there more than 1 seat on the ticket?
      {
        message += "You and your party may sit anywhere in the first 3 rows of the " + ticketSections[i].section + " section. \nPlease be sure to leave no seats between you.";
      }
      else
      {
        message += "You may sit anywhere in the first 3 rows of the " + ticketSections[i].section + " section.";
      }
      break;
    case "standard":
      if (ticketSections[i].seats > 1)    // Are there more than 1 seat on the ticket?
      {
        message += "You and your party may sit anywhere except the first 3 rows of the " + ticketSections[i].section + " section. \nPlease be sure to leave no seats between you.";
      }
      else
      {
        message += "You may sit anywhere except the first 3 rows of the " + ticketSections[i].section + " section.";
      }
      break;
    default:
...
[
  ...
  {amount: 60.00, discount: true,  zombie: false},    // => "ERROR: INVALID TICKET"
...
{
  let message = "";
  let drinkVouch = 0;    // Dollar amount on voucher for drinks

  // Each of the two if-statements, if evaluated to true, adds $10 to drinkVouch
  ...
  switch(tickets[i].amount)    // What is the cost of the ticket?
  {
    case 50:
      if (drinkVouch > 0)    // Is the dollar amount on voucher more than $0?
      {
        message += "STANDARD $" + drinkVouch + " DRINKS";
      }
      else
      {
        message += "STANDARD NO DRINKS"
      }
      break;
    case 65:
      if (drinkVouch > 0)    // Is the dollar amount on voucher more than $0?
      {
        message += "PREMIER $" + drinkVouch + " DRINKS";
      }
      else
      {
        message += "PREMIER NO DRINKS"
      }
      break;
      case 90:
