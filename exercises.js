...
let mySire = album1.albumDetails.label;
...
let sireTally = 0;
for(let k = 0; k < talkingHeadsAlbums.length; k++) {
  if(talkingHeadsAlbums[k].albumDetails.hasOwnProperty("labels"))
  {
    if(talkingHeadsAlbums[k].albumDetails.labels.includes("Sire")){
      sireTally++;
    }
  } else if (talkingHeadsAlbums[k].albumDetails.hasOwnProperty("label")) {
    if(talkingHeadsAlbums[k].albumDetails.label === "Sire") {
      sireTally++;
    }
  }
}
...
for(let j = 0; j < ticketSections.length; j++) {
  if(ticketSections[j].type === "premium") {
    if (ticketSections[j].seats > 1) {
      if(ticketSections[j].section === "left") {
        console.log(`Welcome, ${ticketSections[j].name}! You and your party may sit anywhere in the first 3 rows of the left section.`);
      }
      if(ticketSections[j].section === "center") {
        console.log(`Welcome, ${ticketSections[j].name}! You and your party may sit anywhere in the first 3 rows of the center section.`);
      }
      if(ticketSections[j].section === "right") {
        console.log(`Welcome, ${ticketSections[j].name}! You and your party may sit anywhere in the first 3 rows of the right section.`);
      }
    } else if (ticketSections[j].seats === 1) {
      if(ticketSections[j].section === "left") {
        console.log(`Welcome, ${ticketSections[j].name}! You may sit anywhere in the first 3 rows of the left section.`);
      }
      if(ticketSections[j].section === "center") {
        console.log(`Welcome, ${ticketSections[j].name}! You may sit anywhere in the first 3 rows of the center section.`);
      }
      if(ticketSections[j].section === "right") {
        console.log(`Welcome, ${ticketSections[j].name}! You may sit anywhere in the first 3 rows of the right section.`);
      }
    }
  } else if (ticketSections[j].type === "standard") {
    if (ticketSections[j].seats > 1) {
      if(ticketSections[j].section === "left") {
        console.log(`Welcome, ${ticketSections[j].name}! You and your party may sit anywhere except the first 3 rows of the left section.`);
      }
      if(ticketSections[j].section === "center") {
        console.log(`Welcome, ${ticketSections[j].name}! You and your party may sit anywhere except the first 3 rows of the center section.`);
      }
      if(ticketSections[j].section === "right") {
        console.log(`Welcome, ${ticketSections[j].name}! You and your party may sit anywhere except the first 3 rows of the right section.`);
      }
    } else if (ticketSections[j].seats === 1) {
      if(ticketSections[j].section === "left") {
        console.log(`Welcome, ${ticketSections[j].name}! You may sit anywhere except the first 3 rows of the left section.`);
      }
      if(ticketSections[j].section === "center") {
        console.log(`Welcome, ${ticketSections[j].name}! You may sit anywhere except the first 3 rows of the center section.`);
      }
      if(ticketSections[j].section === "right") {
        console.log(`Welcome, ${ticketSections[j].name}! You may sit anywhere except the first 3 rows of the right section.`);
      }
    }
  }
}
