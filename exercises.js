...
// 1. DONE: Retrieve the string "Sire" from album1, and save it in a sensibly named
//    variable.

let albumLabel = album1.albumDetails.label
console.log(albumLabel)

// 2. DONE: Change the title of album1 from "Talking Heads" to "Talking Heads: 77"
...
// 3. DONE: Access album2's formats array and use an array method to add "LP" to
//    album3's formats
...
// 4. DONE: Change the release date of album3 from a string into a Date object
...
// 5. DONE: Add the label "Sire" to album4's details
...
// 6. DONE: Add a 'formats' array to album 5 and add "CD", "Cassette", and "LP"
...
// 7. DONE: Make the label "emi" in album6 all uppercase
...
// 8. DONE: Convert album7's 'labels' property from the string value
...
// 1. DONE: Write a conditional to console.log "Talking Heads were a prolific band"
...
// 2. DONE: Write a conditional to check if the number of albums in
...
// 3. DONE: Write conditionals to check if the number of albums in
...
// 4. DONE: Check your logic above against the numbers: 0, 1, 2, 6, 7, and 9.
...
// 1. DONE: Use a for loop to print out the name of each Talking Heads album
...
//     sireTally++
//   }
//   if (album.albumDetails.labels === ("Sire")) {
//     sireTally++
//   }
