...
console.log(album1.albumDetails.label + " label")


// 2. Change the title of album1 from "Talking Heads" to "Talking Heads: 77"

album1.title = "Talking Heads: 77"
console.log("The new album itle is " + album1.title)
...
album3.albumDetails.formats = ["Cassette", "LP"]
console.log(album3)
...
album7.albumDetails.labels = album7.albumDetails.labels = ["Sire", "EMI"]
console.log(album7)
...
if (y % 2 == 0 && y % 3 == 0){
   console.log('The number ' + y + ' is divisble by 2 and 3');
} else if (y % 2 == 0) {
  console.log('The number ' + y + ' is divisble by 2');
} else if (y % 3 == 0) {
  console.log('The number ' + y + ' is divisble by 3');
} else {
...
if (zero % 2 == 0 && zero % 3 == 0){
   console.log('The number ' + zero + ' is divisble by 2 and 3');
} else if (zero % 2 == 0) {
  console.log('The number ' + zero + ' is divisble by 2');
} else if (zero % 3 == 0) {
  console.log('The number ' + zero + ' is divisble by 3');
} else {
  console.log('The number ' + zero + ' is not divisible by 2 or 3')
}

let one = 1
if (one % 2 == 0 && one % 3 == 0){
   console.log('The number ' + one + ' is divisble by 2 and 3');
} else if (one % 2 == 0) {
  console.log('The number ' + one + ' is divisble by 2');
} else if (one % 3 == 0) {
  console.log('The number ' + one + ' is divisble by 3');
} else {
  console.log('The number ' + one + ' is not divisible by 2 or 3')
}

let two = 2
if (two % 2 == 0 && two % 3 == 0){
   console.log('The number ' + two + ' is divisble by 2 and 3');
} else if (two % 2 == 0) {
  console.log('The number ' + two + ' is divisble by 2');
} else if (two % 3 == 0) {
  console.log('The number ' + two + ' is divisble by 3');
} else {
  console.log('The number ' + two + ' is not divisible by 2 or 3')
}

let six = 6
if (six % 2 == 0 && six % 3 == 0){
   console.log('The number ' + six + ' is divisble by 2 and 3');
} else if (six % 2 == 0) {
  console.log('The number ' + six + ' is divisble by 2');
} else if (six % 3 == 0) {
  console.log('The number ' + six + ' is divisble by 3');
} else {
  console.log('The number ' + six + ' is not divisible by 2 or 3')
}

let seven = 7
if (seven % 2 == 0 && seven % 3 == 0){
   console.log('The number ' + seven + ' is divisble by 2 and 3');
} else if (seven % 2 == 0) {
  console.log('The number ' + seven + ' is divisble by 2');
} else if (seven % 3 == 0) {
  console.log('The number ' + seven + ' is divisble by 3');
} else {
  console.log('The number ' + seven + ' is not divisible by 2 or 3')
}

let nine = 9
if (nine % 2 == 0 && nine % 3 == 0){
   console.log('The number ' + nine + ' is divisble by 2 and 3');
} else if (nine % 2 == 0) {
  console.log('The number ' + nine + ' is divisble by 2');
} else if (nine % 3 == 0) {
  console.log('The number ' + nine + ' is divisble by 3');
} else {
  console.log('The number ' + nine + ' is not divisible by 2 or 3')
}
...
//  create sirally count
//  create a loop to check all albums with the sire, if it has it add to sirTally
//  
...
// check 1st, check ticket, send message, go to the next stop at end 
//      if premium - premium 3 message
//      else if - sit 3 rows back

// for (let i = 0; i< ticketSections.length; i++) {
//  console.log(ticket[i]);
 if (ticketSections.type == "premium"){
  console.log(ticketSections.name + 'You may sit anywhere in the first 3 rows of the right section.')
} else {
  console.log(ticketSections.name + 'You and your party may sit anywhere except first 3 rows of the center section.')
}
...
/*
if(i = 50 ){
  console.log('STANDARD TICKETS' + varDiscount + varZommbie)
} else if(i = 65 ){
  console.log('PRIMIER'varDiscount + varZommbie)
} else if (i = 90){
  console.log('PRIMIER PLUS'varDiscount + varZommbie)
} else
  consoloe.log('invalid'varDiscount + varZommbie)
