...
//console.log("1. ", ablbum1.albumDetails.label)
...
//  } else { talkingHeadsAlbums.length < 6
...
//    the number of albums.
  // if(talkingHeadAlnums.length % 2 === 0) {
  //   //console.log(`2. The number ${talkingHeadsAlbums} is odd`)
  // } elese {
  //  // console.log(`2. The number ${talkingHeadsAlbums} is odd`)
  // }
...
// if (numAlbums % 2 === 0) {
//   console.log('3. The ${numAlbums} is divisible by 2 `)
// } else if (numAlbums % 3 ===0) {
//  console.log('3. The ${numAlbums} is divisible by 3 ')
// } else if (numAlbums % === && numAlbums % 3 === 0) {
//   console.log('3. The ${numAlbums} is divisible by 2 and 3 ')
// } else {
//   console.log('3. The ${numAlbums} is NOT divisible by 2 and 3 ')
// }
...
//   cosnole.log(talkingHeadsAlbums[i].title)
//}
...
//   //console.log("album", talkingHeadsAlbums[i].albumsDetails)
//   if (talkingHeadsAlbums[i].albumDetails === "Sire" || talkingHeadsAlbums[i] albumDetails.labels.includes("Sire")) {
//     sireTally++
//   }
// }
