...
let sireTally = 0
talkingHeadsAlbums.forEach((el) => {
  if (el.albumDetails.label === 'Sire') {
    sireTally++
  }
  if (el.albumDetails.labels) {
    if (el.albumDetails.labels.includes('Sire')) {
      sireTally++
    }
  }
})
...
ticketSections.forEach((el) => {
  if(el.type === "premium") {
    if(el.seats === 1) {
      console.log(`Welcome, ${el.name}! You may sit anywhere in the first 3 rows of the ${el.section} section.`)
    } else if (el.seats>1) {
      console.log(`Welcome, ${el.name}! You and your party may sit anywhere in the first 3 rows of the ${el.section} section. Please be sure to leave no seats between you.`)
    }
  }
  if(el.type === "standard") {
    if(el.seats === 1) {
      console.log(`Welcome, ${el.name}! You may sit anywhere except the first 3 rows of the ${el.section} section.`)
    } else if (el.seats>1) {
      console.log(`Welcome, ${el.name}! You and your party may sit anywhere except the first 3 rows of the ${el.section} section. Please be sure to leave no seats between you.`)
    }
  }
})
...
tickets.forEach((el)=> {
  ...
  if(el.amount == 50) {
    message = 'STANDARD'
  } else if(el.amount == 65) {
    message = 'PREMIER'
  } else if(el.amount == 90) {
    message = 'PREMIER PLUS'
  } else if(el.amount == 80 && el.discount) {
    message = 'PREMIER PLUS'
  } else {
...
// console.log(album3.albumDetails.labels)
// console.log(album3.albumDetails.label)

// console.log(album7.albumDetails.labels)
// console.log(album7.albumDetails.label)
// console.log(album7.albumDetails.labels.includes())
// console.log(album7.albumDetails.label.includes())
