...
console.log((album1.title = "Talking Heads: 77"));
...
album3.albumDetails.released = new Date("January 31, 2022");
...
const newArry = (album5.fotmats = ["CD", "Cassette", "LP"]);
console.log(album5);
...
const toUpper = album6.albumDetails.labels[1].toUpperCase();
console.log(toUpper);
...
const changeStringToValue = album7.albumDetails.labels.split([" "]);
console.log(changeStringToValue);
