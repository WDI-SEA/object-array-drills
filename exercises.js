...
console.log('1.', sireLabel)

// 2. Change the title of album1 from "Talking Heads" to "Talking Heads: 77"

album1.title = album1.title + ': 77' // concatenation onto current value. instead of overwriting the entire 'title'
...
console.log('3.', album2.albumDetails.formats)
...
let y = talkingHeadsAlbums

if ( y === 0){
  console.log('3', `The number ${y} is not divisible by 2 and 3`)
}

else if( y %2 === y && y % 3 === 0){
  console.log('3.', `The number ${y} is divisible by 2 and 3`)
}
else if(y % 3 === 0){
  console.log('3.', `The number ${y} is divisible by 3`)
}
else if(y % 2 === 0){
  console.log('3.', `The number ${y} is divisible by 2`)
}
else {
  console.log('3.', `The number ${y} is not divisible by 2 and 3`)
}
