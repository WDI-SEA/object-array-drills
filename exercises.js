...
const recordCompany = "label"
console.log(album1.albumDetails[recordCompany])
...
//album3.albumDetails.released = new Date(album3.albumDetails.released)---dynamic, prob more proper method
...
//msg they were prolific
  console.log("Talking Heads were a prolific band")
} else{
 //if false not much output
...
for (let i = 0; i < ticketSections.length; i++) {
  if(ticketSections[i].type === "premium") {
   console.log(`Welcome, ${ticketSections} You may sit anywhere in the first 3 rows of the right section.`) 
  } else if() {
