...
//    variable.
const sireLabel = album1.albumDetails.label
// console.log(sireLabel)
...
// set album1.title = "talking heads:77"
album1.title = "talking heads:77"
// console.log(album1.title)

album1.copiesSold = 99
album1.copiesSold = 110
// console.log(album1.copiesSold)
...
// album3.albumDetails.released.push(new Date("August 3, 1979"))
// const array1 = ["a", "b", "c"]
// array1.push("dfdf")
...
album4.albumDetails.formats = []
album4.albumDetails.formats.push("CD")
album4.albumDetails.formats.push("Cassette")
album4.albumDetails.formats.push("LP")
album4.albumDetails.formats.pop()

// console.log(album4.albumDetails.formats)
...
// console.log(band)
// console.log(talkingHeadsAlbums[0].title)
...
/** Problem 2
  Create a variable called `sireTally`, and set it to the integer value 0.
...
band.albums.forEach((album) => {
  console.log(album.albumDetails.label)
  if (album.albumDetails.label === "Sire") {
    sireTally++
  } else if (album.albumDetails.labels.includes("Sire")) {
    sireTally++
  }
})
// console.log(sireTally)
// if (band.albums.albumDetails.label === "Sire") {
//   sireTally++
// }
// console.log(sireTally)
////////////////////////////////////////////////////////////////////////
...
/** PROBLEM 1
    There is a Talking Heads concert at DAR Constitutional Hall, and
...
// ticketSections.forEach((person) => {
//   if (person.type === "premium") {
//     console.log(
//       `Welcome, ${person.name}! You may sit anywhere in the first 3 rows of the ${person.section} section.\n`
//     )
//   } else {
//     console.log(
//       `Welcome, ${person.name}! You and your party may sit anywhere except first 3 rows of the ${person.section} section\n`
//     )
//   }
// })

/** PROBLEM 2
  There is a concert at the LA County Fairgrounds by the Southland's
