console.log('connect to the html')
////////////////////////////////////////////////
...
album3.albumDetails.released = newDate("August 3, 1979")
...
album4.albumDeatails.label = "Sire"
...
album5.albumDetails.format = ["CD", "Casette", "LP"]
...
album6.albumDetails.labels[1] = album6.albumDetails.labels[1].toUpperCase()// google how to make a string uppercase in js!
...
//    array.
band.memebers.push("Tiny Weymouth", "Chris Franz", "Jerry Harrison")
////////////////////////////////////////////////
...
if(talkingHeadsAlbums.length >= 6) {
  console.log("Talking Heads were a profolic band")
} else {
...
if (y%2 != 0 && y% 3 !=0) {
  ...
  console.log('the number is div by two or three')
}else if (y&3 ===0) {
