...
album1.title = "Talking Dragon Heads: 77"
...
let band = {}
// 2. Give it the property `name` vand set it to "Talking Heads"
...
}else if(albumNums % 2 === 0 && albumNum % 3 === 0) {
  console.log("The number" + albumNums + " is divisible by 2 and 3")
} else if (albumNums % 3 === 0) {
  console.log("The number " + albumNums + " is divisble by 3")
}else if (albumNum % 2 === 0) {
  console.log("The number " + albumNums + " is divisible by 2")
} else {
