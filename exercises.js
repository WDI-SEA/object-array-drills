...
const arbitraryNumber = band.albums.length
if(arbitraryNumber >= 6) {
...
if((arbitraryNumber % 2) == 1) {
  console.log(`The number ${arbitraryNumber} is odd.`)
}
else {
  console.log(`The number ${arbitraryNumber} is even.`)
}
