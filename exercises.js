...
album6.albumDetails.labels[1] = album6.albumDetails.label[1].toUpperCase();
console.log("7. ", album6.albumDetails.label[1]);
const album7 = {
  title: "True Stories",
  albumDetails: {
...
band.albumbs = talkingHeadsAlbums;
...
for (let i = 0; i < talkingHeadsAlbums.length; i++) {
  ...
  if (
    talkingHeadsAlbums[i].albumDetails.label === "Sire" ||
    talkingHeadsAlbums[i].albumDetails.labels.includes("Sire")
  ) {
    sireTally++;
  }
}
