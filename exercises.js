...
band.members.push(`Tiny Weymouth`,`Chris Franz`, `Jerry Harrsion`)
...
//    "Talking heads didn't have much output." Use the array of albums
//    talkingHeadsAlbums above.
 if (talkingHeadsAlbums.length >= 6){console.log(`Talking Heads were a prolific band`)} else {console.log(`Talking heads didn't have much output.`)}
...
if(numAlbums % 2 == 0){console.log(`the number ${numAlbums} is even`)}else{console.log`the number ${numAlbums} is odd`}
...
if (numAlbums % 2 ==0){console.log`the number is divisble by 2`
}else if(numAlbums% 3 ===0){console.log(`the number is divisible by 3`)
}else if(numAlbums % 2 == 0 && numAlbums % 3 == 0){console.log(`the number is divisible by 2 and 3`)
}else{console.log(`the number is not divisible by 2 or 3`)}

// console.log(band.albums.title)
...
for(let i=0; i < talkingHeadsAlbums.length;i++){
  if(talkingHeadsAlbums.albumDetails.label === `Sire`){
    sireTally++
  }else if(talkingHeads.albumDetails.labels.includes('Sire')){sireTally++}
