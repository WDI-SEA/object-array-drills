...
const albumTwoFormats = album2.albumDetails.formats
console.log(albumTwoFormats)
...
const splitLabels = album7.albumDetails.labels.split(', ')
...
const numOfAlb = talkingHeadsAlbums.length
//const numOfAlb = 0
console.log(numOfAlb)
if (numOfAlb === 0) {
  console.log(`The number ${numOfAlb} is not divisible by 2 or 3`)
} else if (numOfAlb % 2 === 0 && numOfAlb % 3 === 0) {
  console.log(`The number ${numOfAlb} is divisible by 2 and 3`)
} else if (numOfAlb % 2 === 0) {
  console.log(`The number ${numOfAlb} is divisible by 2`)
} else if (numOfAlb % 3 === 0) {
  console.log(`The number ${numOfAlb} is divisible by 3`)
} else {
  console.log(`The number ${numOfAlb} is not divisible by 2 or 3`)
}
...
for (let i = 0; i < talkingHeadsAlbums.length - 1; i++) {
...
talkingHeadsAlbums.forEach((element) => {
  ...
  if (element.albumDetails.labels) {
    if (element.albumDetails.labels.includes("Sire")) {
    sireTally++
    }
  }
})
...
ticketSections.forEach((ticketInfo) => {
  if (ticketInfo.type === "premium") {
    if (ticketInfo.seats === 1) {
      console.log(`Welcome, ${ticketInfo.name}! You may sit anywhere in the first 3 rows of the ${ticketInfo.section} section.`)
    } else {
      console.log(`Welcome, ${ticketInfo.name}! You may sit anywhere in the first 3 rows of the ${ticketInfo.section} section. Please be sure to leave no seats between you.`)
    }
  } else {
    if (ticketInfo.seats === 1) {
      console.log(`Welcome, ${ticketInfo.name}! You and your party may sit anywhere except first 3 rows of the ${ticketInfo.section} section.`)
    } else {
      console.log(`Welcome, ${ticketInfo.name}! You and your party may sit anywhere except first 3 rows of the ${ticketInfo.section} section. Please be sure to leave no seats between you.`)
    }
  }
})
...
tickets.forEach((ticket) => {
  ...
  if (drinkDiscount >= 10) {
    ticketMessage += ` $${drinkDiscount} DRINKS`
  }
