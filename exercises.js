...
// if(y % 2 === 0  && y % 3 === 0){
//   // console.log(`the number of ${y} is divisible by 2 and 3`)
// }else if(y % 2 === 0){
//   console.log (`the number of ${y} is divisible by 2`)
// }else if(y % 3 === 0){
//   console.log (`the number of ${y} is divisible by 3`)
// }else(
...
// for (let i = 0; i < band.albums.length; i++ ){
//   if (band.alubumsDetails.labels.contains.includes('Sire')){
//     sireTally++
//   }
//   if (band.alubumsDetails.label.contains.includes('Sire')){
//     sireTally++
//   }
// }
// console.log(sireTally)
...
for (let i = 0; i < ticketSections.length; i++){
  ...
  }else if(ticketSections.lenght.type == "standard"){
