...
band.members.push("Chris Frantz", "Tina Weymouth", "Jerry Harrison")
...
talkingHeadsAlbums.forEach(album =>) {
  if (album.albumDetails.label === "Sire") {
    sireTAlly++
    //  check if it exists
  } else if (album.albumDetails.label.includes("sire")) {
...
ticketSections.forEach((name, section, type, seats) => {
  if (section = "center" && type == "premium" && seats === 1) {
    console.log("Welcome, " + name + " You may sit anywhere in the first 3 rows of the center section.")
  } else if (section = "center" && type == "premium" && seats === 1) {
    console.log("Welcome, " + name + " You may sit anywhere in the first 3 rows of the center section.")
  } else if (section = "center" && type == "premium" && seats === 1) {
    console.log("Welcome, " + name + " You may sit anywhere in the first 3 rows of the center section.")
  } else if (section = "center" && type == "premium" && seats === 1) {
    console.log("Welcome, " + name + " You and your party may sit anywhere in the first 3 rows of the center section. Please be sure to leave no seats between you")
  } else if (section = "center" && type == "premium" && seats === 1) {
    console.log("Welcome, " + name + " You and your party may sit anywhere in the first 3 rows of the center section. Please be sure to leave no seats between you")
  } else if (section = "center" && type == "premium" && seats === 1) {
    console.log("Welcome, " + name + " You and your party may sit anywhere in the first 3 rows of the center section. Please be sure to leave no seats between you")
