...
// // 1. Retrieve the string "Sire" from album1, and save it in a senode nsibly named variable.
...
album6.albumDetails.labels[1] = album6.albumDetails.labels[1].toUpperCase() //overwrite
console.log(album6)
...
// let talkingHead = band.name.album 
// ?? HOW TO SET THE ARRAY TO VALUE?
...
//?? HOW TO ADD NEW ELEMNT TO EXISTING OBJECT WITH ELEMENT?
...
//    have `.labels`, which is an Array!
  ...
  for (let i=0; i<talkingHeadsAlbums.length; i++){
    const album = talkingHeadsAlbums[i]
      ...
      album.albumDetails.labels === 'Sire') {
          sireTally ++
      } 
      }
