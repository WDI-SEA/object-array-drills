...
//    variable.
let firstLabel = album1.albumDetails.label
...
let emi= album6.albumDetails.labels[1]
...
let spl= album7.albumDetails.labels
album7.albumDetails.labels = spl.split(' ')
...
let albLength = talkingHeadsAlbums.length
if(albLength === 0){
  console.log("The number " + albLength + " is not divisible by 2 or 3")
}  else if((albLength % 2) === 0 && (albLength % 3) === 0){
  console.log("The number " + albLength + " is divisible by 2 and 3")
} else if((albLength % 2) === 0){
  console.log("The number " + albLength + " is divisible by 2")
} else if((albLength % 3) === 0){
  console.log("The number " + albLength + " is divisible by 3")
} else {
  console.log("The number " + albLength + " is not divisible by 2 or 3")
}
...
//        I set albLength equal to 0, 1, 2, 6, 7, and 9 under where I defined albLength.
...
//     talkingHeadsAlbums[i].albumDetails.label= talkingHeadsAlbums[i].albumDetails.label.split(' ')
//     talkingHeadsAlbums[i].albumDetails.labels= talkingHeadsAlbums[i].albumDetails.label
//     delete talkingHeadsAlbums[i].albumDetails.label
//   }
    
// }
// console.log(talkingHeadsAlbums)

// for(j=0; j<talkingHeadsAlbums.length; j++){
//     if (talkingHeadsAlbums[j].albumDetails.labels.includes('Sire')){
//       sireTally++
//     } else if(talkingHeadsAlbums[j].albumDetails.labels.includes('Sire,')){
//       sireTally++
//     }
// }
