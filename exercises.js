...
if (test1 % 2 === 0 && test1 % 3 === 0) {
  console.log(`The number ${test1} is divisible by 2 and 3`);
} else if (test1 % 2 === 0) {
  console.log(`The number ${test1} is divisible by 2`);
} else if (test1 % 3 === 0) {
  console.log(`The number ${test1} is divisible by 3`);
} else {
  console.log(`The number ${test1} is not divisible by 2 or 3`);
}
