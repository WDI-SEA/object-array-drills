...
const musicLabel = album1.albumDetails.label
...
// Need Help ------------------------------------------------------------------------------------------
const newLabels = album7.albumDetails.labels.split([])
console.log(album7.albumDetails.newLabels)
...
const aCount = talkingHeadsAlbums.length
if(aCount > 6){
...
for(let i = 1; i < talkingHeadsAlbums.length; i++){
  if(i % 2 === 0){
    console.log("Album " + i + " is even")
  }else{
    console.log("Album " + i + " is odd")
  }
}
...
for(let i = 1; i < talkingHeadsAlbums.length; i++){
  if(i / 2 === 0){
    console.log("Album " + i + " is divisible by 2")
  }else{
    console.log("Album " + i + " is odd")
  }
}
...
while(talkingHeadsAlbums.length > 0){
  i = 0
  let x = i < talkingHeadsAlbums.legth; i++
  console.log(talkingHeadsAlbums.name)
...
//             ----- need help -----
// const sireTally = 0
// for(const element of talkingHeadsAlbums.Label){
//   if(element == "Sire"){
//     count += 1;
//   }
// }
...
for(let seating in ticketSections){
  console.log("Welcome! ", + ticketSections[seating] + seating)
}
