...
if (oddEvenAlbums % 2 === 0) {
  console.log(`The number ${oddEvenAlbums} is even`)
} else {
  console.log(`The number ${oddEvenAlbums} is odd`)
}
...
ticketSections.forEach((ticket) => {
  if (ticket.type === 'premium') {
    ...
    if (ticket.seats === 1) {
      ...
      console.log(`Welcome, ${ticket.name}! You and your party may sit anywhere except the first 3 rows of the ${ticket.section} section. Please be sure to leave no seats between you.`)
    }
  }
})
