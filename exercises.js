...
//    variable.
//--------------------------------------
let albumsLabel = album1.albumDetails.label;
//--------------------------------------
...
for (let i = 0; i < talkingHeadsAlbums.length; i++) {
  ...
  if (typeof talkingHeadsAlbums[i].albumDetails.label == "object") {

    if (talkingHeadsAlbums[i].albumDetails.label[0] == "Sire" || talkingHeadsAlbums[i].albumDetails.label[1] == "Sire")
      sireTally++
  }
...
//    standard, premier, and premier plus seating. Premier plus tickets[i]
//    receive free drinks.
//
...
for (let i = 0; i < tickets.length; i++) {
  storeString = ""
  storeDrink = 0
  if (tickets[i].amount == 80.00 && tickets[i].discount == true) {
    storeString = "PREMIER PLUS"
    storeDrink += 10
    if (tickets[i].zombie == true) {
      storeDrink += 10
    }

    console.log(`${storeString} $${storeDrink} Drinks`)
  }
  else if (tickets[i].amount === 65.00 || tickets[i].amount === 50.00 || tickets[i].amount === 90.00) {
    if (tickets[i].zombie == true)
      storeDrink += 10
    if (tickets[i].amount == 65.00)
      storeString = "PREMIER"
    else if (tickets[i].amount == 50.00)
      storeString = "STANDARD"
    else
      storeString = "PREMIER PLUS"
