...
// const { albumDetails: { formats } } = album3
// formats.push("LP")
// console.log(formats)
// Done
...
album3.albumDetails.released = new Date("January 10, 1981");
...
const labelChange = album6.albumDetails.labels[1].toUpperCase();
album6.albumDetails.labels[1] = labelChange;
...
const labelSplit = album7.albumDetails.labels.split(" ");
album7.albumDetails.labels = labelSplit;
...
const { name, members, albums } = band;
// if (albums.length >= 6) {
...
//   console.log("The number " + albums.length + " is even")
// } else {
//   console.log("The number " + albums.length + " is odd")
// }
...
if (albums.length % 3 === 0) {
  console.log("The number " + albums.length + " is divisible by 3");
}
if (albums.length % 2 === 0 && albums.length % 3 === 0) {
  console.log("The number " + albums.length + " is divisible by 2 and 3");
}
if (albums.length % 2 !== 0 || albums.length % 3 !== 0) {
  console.log("The number " + albums.length + " is not divisible by 2 or 3");
}
...
for (let i = 0; i < albums.length; i++) {
  if (albums[i].albumDetails.label === "Sire") {
    sireTally++;
  }
}

for (let i = 0; i < albums.length; i++) {
  if (albums[i].albumDetails.labels) {
    for (let j = 0; j < albums[i].albumDetails.labels.length; j++) {
      if (albums[i].albumDetails.labels[j] === "Sire") {
        sireTally++;
      }
    }
  }
...
// discount === true $10 drink
// zombie === true $10 drink
...
for (let i = 0; i <= tickets.length; i++) {
  if (tickets[i].amount === 50) {
    if (tickets[i].discount && tickets[i].zombie) {
      console.log("$20");
    } else if (tickets[i].discount) {
      console.log("$10");
