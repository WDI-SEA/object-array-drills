...
console.log('6. ', album5.albumDetails)
  ...
  console.log('8. ', album7.albumDetails)
  ...
  if (talkingHeadsAlbums.length > 5) {
    console.log('Talking Heads were a prolific band.')
        ...
        console.log(`Talking Heads didn't have much out.`)
  }
  ...
  for (let i = 0; i < talkingHeadsAlbums.length; i++) {
    // console.log('2. album', talkingHeadsAlbums[i].albumDetails)
...
const ticketSections = [
  ...
  if(tickets[i].zombie === true) {
    ...
    if(tickets[i].amount === 50.00) {
        ...
        voucherValue > 0 ? console.log(`PREMIERE $${voucherValue} DRINK`):
        console.log(`PREMIERE NO DRINKS`) 
